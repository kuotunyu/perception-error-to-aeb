...
.replay-shell{max-width:1320px;margin:0 auto;padding:32px 32px 40px;}
.page-heading{display:flex;align-items:center;justify-content:space-between;gap:24px;padding:0 0 24px;border-bottom:2px solid #142033;}
h1{font-size:32px;line-height:1.3;font-weight:700;letter-spacing:.02em;margin:0;}
.scenario-name{margin:8px 0 0;font-size:17px;color:#425d70;overflow-wrap:anywhere;}
.project-name{font-size:18px;color:#254c62;white-space:nowrap;}
.scenario-bar{display:flex;align-items:baseline;gap:16px;padding:20px 0;}
h2{font-size:18px;line-height:1.5;margin:0;font-weight:700;}
.scenario-bar h2{flex:none;}
.configuration{list-style:none;padding:0;margin:0;display:flex;flex-wrap:wrap;gap:6px 20px;}
.configuration li{font-size:17px;color:#254c62;overflow-wrap:anywhere;}
.replay-workspace{background:white;border:1px solid #cddbe3;border-radius:12px;}
.scene-key{display:flex;align-items:center;justify-content:space-between;gap:16px;padding:18px 24px;border-bottom:1px solid #dfe8ed;flex-wrap:wrap;}
...
details{font-size:16px;grid-column:1/-1;}summary{cursor:pointer;color:#254c62;}
...
<header class="page-heading"><div><h1>情境回放</h1><p class="scenario-name">$heading</p></div><div class="project-name">Perception error → AEB</div></header>
...
</ul><p>回放範圍 $start&ndash;$end s · 單位 m</p></div>
<section class="replay-canvas" aria-label="情境幾何與回放控制">$plot</section>
</div>
<aside class="replay-context" aria-label="回放說明">
